...
class ArrowRightDrawable (private val context: Context, private val enable:Boolean) : Drawable() {
    ...
    override fun draw(canvas: Canvas) {
        ...
        val pointer = Point((bounds.width()*0.8).toInt(),bounds.centerY())
        val upper = Point((bounds.width()*0.2).toInt(), (bounds.height()*0.2).toInt())
